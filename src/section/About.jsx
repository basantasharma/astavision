...
const About = () => {
  return (
    <div
      className="p-5 lg:px-24 bg-white text-black dark:text-white  dark:bg-slate-900 "
      id="about"
    >
      <div id="about" class="relative overflow-hidden mt-5 lg:mt-20">
        <div class="max-w-7xl">
          <div class="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
            ...
            <main class="mt-10 max-w-7xl sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28">
              <div class="sm:text-center lg:text-left md:pr-10">
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            class="h-56 w-full object-cover object-top rounded-lg sm:h-72 md:h-96 lg:w-full lg:h-full"
