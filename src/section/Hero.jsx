...
const Hero = () => {
  return (
    <section
      id="hero"
      className="container mx-auto flex flex-col bg-white xl:flex-row justify-center min-h-screen px-4 lg:px-24 gap-4 lg:gap-11 overflow-hidden"
    >
      <div className="relative order-2 md:order-1 xl:w-2/5 w-full p-5 lg:p-0 flex flex-col justify-center items-start leading-8 z-10">
        ...
        <h1 className="mt-4 text-4xl md:text-6xl font-bold leading-tight md:leading-[80px]">
          <span className="relative z-10 pr-2 xl:bg-white xl:whitespace-nowrap">
